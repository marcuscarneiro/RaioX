	...
	<div class="container">
		<div class="row">
			<div class="container" id="formContainer">
				<form:form class="form-horizontal" action="salvaEscola" method="POST" modelAttribute="escola" enctype="multipart/form-data">
					<fieldset>
						...
						<c:if test="${not empty escola.fotoCapa}">
							<div class="form-group">
							<label class="col-sm-3 control-label" for="fotoCapa"><strong>Foto atual</strong></label>
								<div id="fotoCapa" class="col-sm-4">
									<img class="fotoCapa" alt="" src="<%=request.getContextPath()%>${escola.fotoCapa}">
								</div>
							</div>
						</c:if>
						...
						<div class="form-group">
							...
							<div class="col-sm-1 formradio">
								<form:radiobutton id="nova" path="nova" value="false" />  NÃO</div>
						</div>
