...
<body>
	...
	<div class="container">
		<!-- Form Name -->
		<h1>Fotos da vistoria - ${vistoriaCreche.creche.nome}</h1>
		
		<hr>
		<div class="panel-body">
			<div>
				<form:form id="dropzone-form" modelAttribute="vistoriaCreche" class="dropzone"
				...
				<a class="btn btn-primary pull-right" href="verFotosCreche?id=${vistoriaCreche.id}"> 
					Ver todas as fotos
				</a>
			</div>
		</div>
	...
	<script src="<%=request.getContextPath()%>/views/assets/js/fotoCreche.js"></script>
</body>
</html>