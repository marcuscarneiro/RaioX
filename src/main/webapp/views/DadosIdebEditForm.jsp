	...
	<div class="container">
		<div class="row">
			<div class="container" id="formContainer">
				<form:form class="form-horizontal" action="salvaDadosIdeb" modelAttribute="dadosIdeb" method="POST">
					<fieldset>
						...
						<div class="form-group">
							...
							<div class="col-sm-12">
								<form:select path="escola.id" class="form-control">
									<c:if test="${not empty dadosIdeb.escola.id}">
										<c:forEach items="${escolas}" var="escola">
											<option value="${dadosIdeb.escola.id}">${dadosIdeb.escola.nome}</option>
										</c:forEach>
									</c:if>
						...
						<div class="iniciais col-xs-12 col-sm-12 col-md-12 col-lg-12">
							...
							<div class="idebs-iniciais col-xs-6 col-sm-6 col-md-6 col-lg-6">
								...
								<div class="form-group">
									...
									<div class="col-sm-12">
										<form:input id="did_ideb_2007_ini" name="did_ideb_2007_ini" type="text" class="form-control" path="did_ideb_2007_ini" />
									</div>
								</div>
