					...
					<div class="escola-mobile-aprendizado">
						<div class="aprendizado-port-ini aprendizado-group">
							...
							<div class="port-ini-grafico aprendizado-grafico">
								<span id="port-ini-circle-1"></span>
								<span id="port-ini-circle-2"></span>
								<span id="port-ini-circle-3"></span>
								<span id="port-ini-circle-4"></span>
								<span id="port-ini-circle-5"></span>
								<span id="port-ini-circle-6"></span>
								<span id="port-ini-circle-7"></span>
								<span id="port-ini-circle-8"></span>
								<span id="port-ini-circle-9"></span>
								<span id="port-ini-circle-10"></span>
								<span id="port-ini-circle-11"></span>
								<span id="port-ini-circle-12"></span>
								<span id="port-ini-circle-13"></span>
								<span id="port-ini-circle-14"></span>
								<span id="port-ini-circle-15"></span>
								<span id="port-ini-circle-16"></span>
								<span id="port-ini-circle-17"></span>
								<span id="port-ini-circle-18"></span>
								<span id="port-ini-circle-19"></span>
								<span id="port-ini-circle-20"></span>
							</div>
						...
						<div class="aprendizado-mat-ini aprendizado-group">
							...
							<div class="mat-ini-grafico aprendizado-grafico">
								<span id="mat-ini-circle-1"></span>
								<span id="mat-ini-circle-2"></span>
								<span id="mat-ini-circle-3"></span>
								<span id="mat-ini-circle-4"></span>
								<span id="mat-ini-circle-5"></span>
								<span id="mat-ini-circle-6"></span>
								<span id="mat-ini-circle-7"></span>
								<span id="mat-ini-circle-8"></span>
								<span id="mat-ini-circle-9"></span>
								<span id="mat-ini-circle-10"></span>
								<span id="mat-ini-circle-11"></span>
								<span id="mat-ini-circle-12"></span>
								<span id="mat-ini-circle-13"></span>
								<span id="mat-ini-circle-14"></span>
								<span id="mat-ini-circle-15"></span>
								<span id="mat-ini-circle-16"></span>
								<span id="mat-ini-circle-17"></span>
								<span id="mat-ini-circle-18"></span>
								<span id="mat-ini-circle-19"></span>
								<span id="mat-ini-circle-20"></span>
							</div>
						...
						<div class="aprendizado-port-fin aprendizado-group">
							...
							<div class="port-fin-grafico aprendizado-grafico">
								<span id="port-fin-circle-1"></span>
								<span id="port-fin-circle-2"></span>
								<span id="port-fin-circle-3"></span>
								<span id="port-fin-circle-4"></span>
								<span id="port-fin-circle-5"></span>
								<span id="port-fin-circle-6"></span>
								<span id="port-fin-circle-7"></span>
								<span id="port-fin-circle-8"></span>
								<span id="port-fin-circle-9"></span>
								<span id="port-fin-circle-10"></span>
								<span id="port-fin-circle-11"></span>
								<span id="port-fin-circle-12"></span>
								<span id="port-fin-circle-13"></span>
								<span id="port-fin-circle-14"></span>
								<span id="port-fin-circle-15"></span>
								<span id="port-fin-circle-16"></span>
								<span id="port-fin-circle-17"></span>
								<span id="port-fin-circle-18"></span>
								<span id="port-fin-circle-19"></span>
								<span id="port-fin-circle-20"></span>
							</div>
						...
						<div class="aprendizado-mat-fin aprendizado-group">
							...
							<div class="mat-fin-grafico aprendizado-grafico">
								<span id="mat-fin-circle-1"></span>
								<span id="mat-fin-circle-2"></span>
								<span id="mat-fin-circle-3"></span>
								<span id="mat-fin-circle-4"></span>
								<span id="mat-fin-circle-5"></span>
								<span id="mat-fin-circle-6"></span>
								<span id="mat-fin-circle-7"></span>
								<span id="mat-fin-circle-8"></span>
								<span id="mat-fin-circle-9"></span>
								<span id="mat-fin-circle-10"></span>
								<span id="mat-fin-circle-11"></span>
								<span id="mat-fin-circle-12"></span>
								<span id="mat-fin-circle-13"></span>
								<span id="mat-fin-circle-14"></span>
								<span id="mat-fin-circle-15"></span>
								<span id="mat-fin-circle-16"></span>
								<span id="mat-fin-circle-17"></span>
								<span id="mat-fin-circle-18"></span>
								<span id="mat-fin-circle-19"></span>
								<span id="mat-fin-circle-20"></span>
							</div>
