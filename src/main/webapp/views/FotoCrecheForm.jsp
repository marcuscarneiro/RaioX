	...
	<div class="container">
		<div class="row">
			<div class="container" id="formContainer">
				<form:form class="form-horizontal" action="salvaFotoCreche" method="POST" modelAttribute="foto">
					<fieldset>
						...
						<form:input type="hidden" path="vistoriaCreche.id" />
						...
						<!-- Text input-->
						<div class="form-group">
							<label class="col-sm-3 control-label" for="creche"><strong>Creche</strong></label>
							<div class="col-sm-4">
								<span id="escola">${foto.vistoriaCreche.creche.nome}</span>
							</div>
						</div>
